...
class RichManAssets:
	...
	#
	I_RM_MODE_THROW = RuleImage(roi_front=(1053,582,83,38), roi_back=(1034,562,121,76), threshold=0.8, method="Template matching", file="./tasks/RichMan/rm/rm_rm_mode_throw.png")
	#
